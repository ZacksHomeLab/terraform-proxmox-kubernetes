...
| <a name="input_ext_apiserver_lb_port"></a> [ext\_apiserver\_lb\_port](#input\_ext\_apiserver\_lb\_port) | (String) The default port the External Apiserver LB will listen on. Default is 443. | `number` | `443` | no |
